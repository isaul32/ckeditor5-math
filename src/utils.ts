...
import type { Element as CKElement, DocumentSelection } from 'ckeditor5/src/engine';
...
export function getSelectedMathModelWidget( selection: DocumentSelection ): null | CKElement {
...
export function extractDelimiters( equation: string ): { equation: string; display: boolean } {
...
export async function renderEquation(
	equation: string,
	element: HTMLElement,
	engine: 'katex' | 'mathjax' | undefined | ( ( equation: string, element: HTMLElement, display: boolean ) => void ) = 'katex',
...
export function getBalloonPositionData( editor: Editor ): {
	target: Range | HTMLElement; positions: Array<PositioningFunction>;
} {
...
function getPreviewElement( element: HTMLElement, previewUid: string, previewClassName: Array<string> ) {
